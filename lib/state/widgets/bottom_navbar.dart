...
class BottomNavBar extends StatelessWidget {
  ...
  const BottomNavBar({this.currentLocation, Key? key}) : super(key: key);
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => showDialog<String>(
                      context: context,
                      builder: (BuildContext context) => _initDialog()),
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                _createSyncInfomationbyRow("위치", "사무실"),
                _createSyncInfomationbyRow("시간", "15:55"),
              ],
            ),
          ),
          // 메세지
